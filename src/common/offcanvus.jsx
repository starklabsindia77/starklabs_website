        ...
        <>
            <div className="tpoffcanvas-area">
                <div className={`tpoffcanvas ${sidebarOpen && "opened"}`}>
                    ...
                    <Link href="#"><Image src={canvus_img_1}  alt="starklabs" /></Link>
                    <Link href="#"><Image src={canvus_img_2}  alt="starklabs" /></Link>
                    <Link href="#"><Image src={canvus_img_3}  alt="starklabs" /></Link>
                    <Link href="#"><Image src={canvus_img_4}  alt="starklabs" /></Link>
                    </div>
