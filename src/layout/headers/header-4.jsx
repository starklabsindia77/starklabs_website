...
import logo from "../../../public/assets/img/logo/Starklabs-dark.png";
import white_logo from "../../../public/assets/img/logo/Starklabs.png";
import black_logo from "../../../public/assets/img/logo/Starklabs-dark.png";
                     ...
                     <div className="row g-0 align-items-center"> 
                        <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-6">
                           <div className="header-bottom__logo">
                              {
                                 style_error ? 
                              <Link href="/"><Image src={logo} alt="starklabs" /></Link>
                              :
                              <>
                              <Link className="white-logo" href="/"><Image src={white_logo} alt="starklabs" /></Link>
                              <Link className="black-logo" href="/"><Image src={black_logo} alt="starklabs" /></Link>                     
                              </>
