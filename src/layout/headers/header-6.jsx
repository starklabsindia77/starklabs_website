...
import logo_black from "../../../public/assets/img/logo/Starklabs-dark.png";
import logo_white from "../../../public/assets/img/logo/Starklabs.png";
                  ...
                  <div className="row g-0 align-items-center">
                     <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-6">
                        <div className="header-bottom__logo">
                           {style_2 ? <Link href="/">
                              <Image src={logo_black} alt="starklabs" />
                           </Link> : <><Link className="white-logo" href="/">
                              <Image src={logo_white} alt="starklabs" />
                           </Link>
                     ...
                     <div className="col-xxl-7 col-xl-7 col-lg-7 d-none d-lg-block ">
                        <div className="header-bottom__main-menu header-bottom__main-menu-4 header-bottom__main-menu-inner d-flex justify-content-center" >
                           <nav id="mobile-menu">
                              <NavMenu />
                           </nav>
                        </div>
